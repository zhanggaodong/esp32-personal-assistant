...
<style>
  ...
  .row input[type=text],.row input[type=number],.row select,.row input[type=color]{width:220px;padding:6px 8px;border:1px solid #c9cdd3;border-radius:6px;font-size:14px}
