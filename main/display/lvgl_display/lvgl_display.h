...
public:
    ...
    virtual void ShowCountdown(int duration_sec) override;
    virtual void UpdateCountdown(int remaining_sec) override;
...
protected:
    ...
    lv_font_t* countdown_time_font_ = nullptr;
    // cbin_font_t removed, using lv_font_t* directly for countdown_time_font_
